...
class CreateFunction:
    def __init__(self, master, read_function_instance=None):
        ...
        self.employeeID_label = Label(master, text="Employee_id:")
        self.employeeID_label.grid(row=1, column=0, padx=20, pady=10, sticky="e")

        self.department_label = Label(master, text="Department:")
        ...
        self.employeeID_entry = Entry(master)
        self.employeeID_entry.grid(row=1, column=1, padx=20, pady=10, sticky="w")
    ...
    def insert_and_update(self):
        ...
        self.insert_data(name, employee_id, department)
    ...
    def insert_data(self, n, id, d):
        ...
        cursor.execute("INSERT INTO lecturers VALUES (Null, ?, ?, ?)", (n, id, d))
        connection.commit()
...
class UpdateFunction:
    def __init__(self,master):
        ...
        self.id_label = Label(master, text="Lecturer_ID:")
    ...
    def update_table(self):
        ...
        self.update_database(name, employee_id, department, lecturer_id)
...
class DeleteFunction:
    def __init__(self, master):
        ...
        self.id_label = Label(master, text="Employee_ID:")
        self.id_label.grid(row=3, column=0, padx=20, pady=10, sticky="e")
    ...
    def delete_data_database(self, id_to_delete):
        connection = sqlite3.connect("management_system.db")
        cursor = connection.execute("DELETE FROM lecturers WHERE id=?", (id_to_delete,))
        connection.commit()
